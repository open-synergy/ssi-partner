...
class CustomerPortalExtended(CustomerPortal):
    ...
    def academics(self):
        ...
        return request.render('ssi_partner_experience_portal.portal_my_academics', values, headers={
    ...
    def academic(self, **post):
        ...
        if id:
            id = int(id)
            current_academic_id = academic_obj.search([
                ('id', '=', id)
            ])
            values.update({
        ...
        if request.httprequest.method == 'POST':
            ...
            if error_messages:
                ...
                return request.render('ssi_partner_experience_portal.portal_my_academic', values, headers={
                    'X-Frame-Options': 'DENY'
                })
    ...
    def experiences(self):
        ...
        return request.render('ssi_partner_experience_portal.portal_my_experiences', values, headers={
            'X-Frame-Options': 'DENY'
        })
    ...
    def experience(self, **post):
        ...
        if id:
            id = int(id)
            current_experience_id = experience_obj.search([
                ('id', '=', id)
            ])
            values.update({
        ...
        if request.httprequest.method == 'POST':
            ...
            if error_messages:
                values['error_message'] = '\n'.join(error_messages)
                return request.render('ssi_partner_experience_portal.portal_my_experience', values, headers={
                    'X-Frame-Options': 'DENY'
                })
