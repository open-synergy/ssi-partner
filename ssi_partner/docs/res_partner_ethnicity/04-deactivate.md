...
- Deactivated ethnicities cannot be selected on new individual `res.partner` records.
- Contacts that already reference this ethnicity can still be viewed.
